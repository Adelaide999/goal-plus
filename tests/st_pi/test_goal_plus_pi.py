...
MULTI_SEARCH_PROMPT = (
    ...
    "两次都设置 worker_host=pi-rpc、orchestration_mode=parallel_loops、"
    "max_parallel=1 且不设置已弃用的 max_candidates，worker budget 为 "
    "max_runtime_seconds=60、max_turns=4、"
...
SPEC_REVISION_PROMPT = (
    ...
    "orchestration_mode=parallel_loops、max_parallel=1 且不设置已弃用的 max_candidates，worker budget "
