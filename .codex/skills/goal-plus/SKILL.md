...
`metadata={"orchestration_monitor":{"native_operation":"spawn_agent"}}`。任务包必须包含
objective、scope、依赖和 acceptance，并使用
`fork_turns="none"`。spawn 成功后立即用原 attempt、generation、实际 handle 和相同的
