...
This example records the same ordinary Goal Plus subagent dispatch through representative
...
proves that both hosts expose the same assignment and semantic event flow while
