...
- 公开指标饱和、当前没有未验证 diff 或同分会回滚，都不代表 hidden 泛化搜索结束。在最低 lease 释放前，继续选择有实际 Evidence 支持的泛化、反例、结构边界或简化方向并验证；同分或回滚的 Evidence 及其补充评价仍保留在 Global Evidence 中。
